...
def string(num, length, tense, k, t, math_dt, anim_dt, anim_speed=1, anim_show={}, fixate_edges=True, damping=0.0):
    parts = []
...
string(100, 10000, 0.5, 18000, 120, 0.01, 0.04, anim_speed=6, damping=0.1)
